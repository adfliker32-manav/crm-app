...
const createCompany = async (req, res) => {
    try {
        ...
        const newCompany = await User.create({
            ...
            // Super Admin creates accounts already approved ΓÇö no pending flow needed
            is_active: true,
...
const impersonateUser = async (req, res) => {
    try {
        ...
        // Security Log
        console.log(`≡ƒÜ¿ ALERT: Super Admin (${req.user.email}) is impersonating ${targetUser.email}`);
...
// ==========================================
// ≡ƒ¢í∩╕Å COMMAND CENTER AUDIT LOGS
// ==========================================
...
// ==========================================
// ≡ƒ¢æ EMERGENCY: GLOBAL KILL SWITCHES
// ==========================================
...
// ==========================================
// ≡ƒÜ¿ CORE CRITICAL MONITORING (ALERT LOGIC)
// ==========================================
const analyzeHealthStatus = (metrics) => {
    ...
    // 3∩╕ÅΓâú Automation Engine & Queue Backlog
    ...
    // 5∩╕ÅΓâú Messaging Delivery Health
...
// ==========================================
// ≡ƒÅó AGENCY GOVERNANCE: Allocate Plan Limits
// ==========================================
...
// ============================================================
// ≡ƒö¡ SUPER ADMIN ΓÇö WORKSPACE ANALYTICS COCKPIT
...
// ==============================================================
// Γ£à APPROVAL-BASED ACCESS CONTROL (Core System)
...
// @desc  Approve an account ΓÇö sets it live and usable
...
module.exports = {
    ...
    // Γ£à Approval-Based Access Control
    getPendingRequests,
    getActiveAccounts,
    getRejectedAccounts,
    approveAccount,
