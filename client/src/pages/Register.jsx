            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md animate-fade-in-up">
                <div className="text-center mb-8">
                    <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i className="fa-solid fa-user-plus text-3xl text-red-600"></i>
                    </div>
                    <h2 className="text-2xl font-bold text-gray-800">Create Account</h2>
                    <p className="text-gray-500 mt-1">Join CRM Pro today</p>
                </div>
                ...
                <div className="mt-8 text-center">
                    ...
                    <Link to="/login" className="w-full block bg-white border-2 border-slate-200 hover:border-red-500 text-slate-600 hover:text-red-600 font-bold py-2.5 rounded-lg transition">
                        Login
                    </Link>
                </div>
