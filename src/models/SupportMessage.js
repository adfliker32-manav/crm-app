...
const supportAttachmentSchema = new mongoose.Schema({
    ...
    // Object-storage key (support/<ticketId>/<uuid>.<ext>). Absent on rows
    // uploaded before attachments moved off the local disk — those still
    // resolve through the legacy uploads/support/ path.
